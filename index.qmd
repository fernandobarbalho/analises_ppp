...
Como se vê logo acima algumas colunas que podem ser muito inmportante para as análises apresentam valores ausentes, destaque para **data_encerramento_licitacao** e **valor_contrato**. É interessante fazer investigações mais aprofundada para conhecer melhor as regras de negócio associadas e identificar eventuais problemas na consistência da base de dados.
...
```{r}
modelo_regressao<- lm(valor_contrato ~ supersegmento + situacao + ente +modalidade_contrato + criterio_julgamento,
